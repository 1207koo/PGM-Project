...
parser.add_argument("--model", type=str, default="ResNet12", help="model to train")
parser.add_argument("--sampler-model", type=str, default="", help="sampler model to train")
...
parser.add_argument("--load-sampler-model", type=str, default="", help="load sampler model from file")
parser.add_argument("--load-discriminator-model", type=str, default="", help="load discriminator model from file")
